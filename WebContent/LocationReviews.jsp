...
<br/>
	<center>
<form name="f1" method="post" action="LocationReviews" onsubmit="return validate(this);"><br/>
   <h2><b>Location Based Reviews Screen</b></h2>
   <br/>
	<%
	...
	if(res != null){
		out.println("<center><font face=verdana color=white>"+res+"</center></font>");
			 ...
			 <tr><td><b>Latitude</b></td><td><input type="text" name="t1" style="font-family: Comic Sans MS" size="30"/></td></tr>

			  <tr><td><b>Longitude</b></td><td><input type="text" name="t2" style="font-family: Comic Sans MS" size="30"/></td></tr>

			   <tr><td><b>Product&nbsp;Name</b></td><td><input type="text" name="t3" style="font-family: Comic Sans MS" size="30"/></td></tr>
